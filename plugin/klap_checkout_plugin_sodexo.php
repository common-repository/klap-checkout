 ...
 */
class KlapCheckoutPluginSodexo extends KlapCheckoutPluginBase {

    /**
     * construct plugin sodexo.
     */
    public function __construct() {
      parent::loadDependencies();
      $this->id = 'klap_checkout_sodexo';
      $this->version = MCP_PLUGIN_VERSION;
      $this->plugin_name = 'klap_checkout_sodexo';
      $this->icon = apply_filters('woocommerce_KlapCheckout_icon', plugin_dir_url(dirname(__FILE__)) . 'public/images/sodexo.svg');
      $this->has_fields = false;
      $this->title ='Klap Checkout Sodexo';
      $this->method_title = $this->title;
      $this->method_description = 'Paga con Klap Checkout (' . $this->version . '). Podrás comprar con tus tarjeta sodexo.';
      $this->supports = array('products');
      $this->description = 'Paga con tu rut y clave dinámica.';
    ...
    public function payment_fields(){
      echo wpautop(wptexturize('Paga con tu rut y clave dinámica.'));
    }
    ...
    public function createOrder($referenceId) {
      parent::createOrderBase($referenceId, self::SODEXO);
    }
    ...
    public function init_form_fields() {
      parent::init_form_fields_base(self::SODEXO);
    }
}
